...
namespace memory_manager
{
	...
	bool set_guest_page_permissions(cr3 guest_cr3, cr3 slat_cr3, std::uint64_t guest_base, std::uint64_t offset, std::uint64_t size, bool allow_read, bool allow_write, bool allow_execute);
}
